...
# Open the video file
cap = cv2.VideoCapture("1.object_counting\\test1.mp4")
...
video_writer = cv2.VideoWriter("1.object_counting\\object_counting_output1.avi", cv2.VideoWriter_fourcc(*"mp4v"), fps, (w, h))
